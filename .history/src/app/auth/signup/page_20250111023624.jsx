...
export default function SignupPage() {
    ...
    const handleGoogleLogin = (response) => {
        if (response.credential) {
            // Send the Google credential (token) to your backend for verification
            console.log('Google Login successful, token:', response.credential);

            // Optionally, handle Google login success (e.g., store token in localStorage)
            localStorage.setItem('googleToken', response.credential);

            // You can also send this token to your backend for further processing
            // Example: sendTokenToBackend(response.credential);
