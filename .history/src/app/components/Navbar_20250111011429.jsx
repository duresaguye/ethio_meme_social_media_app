...
import { FaUserPlus, FaSignInAlt, FaInfoCircle, FaHome, FaPassport, FaUser, FaSignOutAlt } from 'react-icons/fa';
...
const Navbar = () => {
    ...
    const { isAuthenticated, logout } = useAuth(); // Assuming `useAuth` returns an object with `isAuthenticated` and `logout`
                    ...
                    <div className="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg">
                        ...
                        {isAuthenticated && (
                            <>
                                ...
                                <button
                                    onClick={logout}
                                    className="flex items-center w-full px-4 py-2 text-gray-800 hover:bg-gray-200"
                                >
